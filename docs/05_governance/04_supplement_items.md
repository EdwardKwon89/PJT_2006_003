...
## v1.0 | 2026-04 | 참조: 00_MASTER.md, 04_dev/02_paperclip_org.md, 02_board_decisions.md

---
> **Agent 사용 지침**
> PM·CEO Agent가 보완 항목 진행 상황 점검 시 로드.
> 각 항목 담당 Agent가 작업 착수 시 해당 섹션 참조.
> Board 결정 필요 항목은 [02_board_decisions.md](./02_board_decisions.md)와 함께 읽을 것.
...
1. [영역 1: 즉시 착수 (Week 1~2)](#영역-1-즉시-착수-week-12)
2. [영역 2: G-HARD 1 전 완료](#영역-2-g-hard-1-전-완료-m1-23주)
3. [영역 3: G-HARD 3 전 완료](#영역-3-g-hard-3-전-완료-m2-말)
4. [영역 4: Phase 진행 중 (M3~M10)](#영역-4-phase-진행-중-m3m10)
5. [영역 5: Phase 8 이후 (Innovation Division)](#영역-5-phase-8-이후-innovation-division-활성화)
6. [전체 타임라인 요약](#전체-타임라인-요약)
7. [항목별 추적 매트릭스](#항목별-추적-매트릭스)
...
Board 필요: 1순위 콘세셔네어 선정 결정 → [BD-01]
...
**상태:** ⏳ Pending | **기한:** Phase 1 착수 시 (Week 1)
...
Board 필요: 협상 하한선 결정 → [BD-02]
```

**상태:** ⏳ Pending | **기한:** G-HARD 0 전
...
Board 필요: 법무법인 선임 즉시 결정 → [BD-03]
```

**상태:** ⏳ Pending | **기한:** Week 2 필수
...
Board 필요: Level 1 최대 허용 범위 확정 → [BD-07]
```
...
상세: → [../03_data/05_security_compliance.md](../03_data/05_security_compliance.md)
```

**상태:** ✅ 설계 문서 완료 | **구현:** Phase 1~3
...
처리 방법:
  DR 아키텍처:
    ...
    RPO 목표: Board 결정 필요 → [BD-15]
    RTO 목표: Board 결정 필요 → [BD-15]
...
**상태:** ⏳ Pending | **기한:** Phase 1 CI/CD 구축 시
...
계획 반영: Phase 12 운영 이관 섹션
활성화 시점: Phase 10 시작 시 착수
Board 결정: → [BD-20] Agent → 정규직 전환 기준
```
...
Board 필요: 외부 데이터 판매 허용 범위·가격 정책 → [BD-11], [BD-12]
```

**상태:** ⏳ Pending | **기한:** G-HARD 7 전
...
| ID | 항목 | 담당 Agent | 시점 | Status | Board 결정 |
|----|------|-----------|------|--------|-----------|
| 필수-1 | 수주·영업 전략 | CEO+CIO | Week 2 | ⏳ | BD-01 |
| 필수-2 | Mock 테스트 환경 | DevOps+Comm+Intg | Phase 1 착수 | ⏳ | — |
| 필수-3 | 수수료 구조 & BEP | CIO+Innovation | G-HARD 0 전 | ⏳ | BD-02 |
| 필수-4 | 법적 계약 구조 | Compliance+CEO | Week 2 | ⏳ | BD-03 |
| 중요-1 | 결제 실패 시나리오 | TXN+Billing+Intg | G-HARD 1 전 | ⏳ | BD-06 |
| 중요-2 | AI 결정 책임 귀속 | Compliance+AI | G-HARD 1 전 | ⏳ | BD-07 |
| 보완-1 | ANPR 이미지 정책 | Compliance+DA+DBA | G-HARD 1 전 | ✅ 문서완료 | BD-17 |
| 중요-3 | DR/BCP | DevOps+Security+DBA | G-HARD 3 전 | ⏳ | BD-15 |
| 중요-4 | API 버전 관리 | CTO+Backend+Intg | G-HARD 3 전 | ⏳ | BD-16 |
| 중요-5 | 보안 인증 로드맵 | Security+Compliance | G-HARD 3 전 | ⏳ | BD-14 |
| 선택-1 | 오픈소스 라이선스 | Security+DevOps | Phase 1 CI/CD | ⏳ | — |
| 중요-6 | 데이터 마이그레이션 | DA+DBA+DevOps | Phase 10 | ⏳ | — |
| 보완-2 | Agent 충돌 방지 | PM+CEO | Phase 1 전 | ⏳ | — |
| 보완-3 | 코드 품질 기준 | CTO+QA | Phase 1 CI/CD | ⏳ | — |
| 보완-4 | 변경 관리 프로세스 | PM+CTO+CEO | Phase 1 착수 | ⏳ | — |
| 중요-7 | 고객 지원 체계 | CPO+PM+Compliance | Phase 8 후 | ⏳ | — |
| 보완-5 | 운영팀 전환 계획 | CEO+PM+CPO | Phase 10 | ⏳ | BD-20 |
| 중요-8 | 혁신 서비스 수익화 | CIO+Innovation+BD | Phase 8 후 | ⏳ | BD-11, BD-12 |

---

## 참조 문서

- [01_decision_gates.md](./01_decision_gates.md) — G-HARD 0~7 게이트 상세 정의
- [02_board_decisions.md](./02_board_decisions.md) — 21개 Board 결정 사항 전체 목록
- [03_reporting_cycle.md](./03_reporting_cycle.md) — 보고 체계 및 Heartbeat 스케줄
...
*작성일: 2026-04*
*버전: v1.0 (기초 문서 04_supplement_items.md → 정제)*
